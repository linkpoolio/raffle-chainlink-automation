...
interface IGiveawayManager {
    function enterGiveaway(uint256 giveawayId, uint8 entries, bytes32[] memory proof) external payable;
    ...
    function setProvenanceHash(uint256 giveawayId, bytes memory provenanceHash) external;
