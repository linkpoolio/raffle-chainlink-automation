...
import {VRFDirectFunding} from "@src/VRFDirectFunding.sol";
import {LinkTokenInterface} from "@chainlink/contracts/src/v0.8/interfaces/LinkTokenInterface.sol";

contract VRFDirectFundingScript is Script {
    using stdJson for string;

    VRFDirectFunding vrfDirectFunding;
    ...
    function configureNetwork(string memory input)
        internal
        view
    ...
    function run() public {
        ...
        vrfDirectFunding = new VRFDirectFunding(
